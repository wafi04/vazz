...
CREATE TABLE "ovos" (
    ...
    CONSTRAINT "ovos_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "voucher_usages_user_idx" ON "voucher_usages"("user");

-- CreateIndex
CREATE INDEX "voucher_usages_status_idx" ON "voucher_usages"("status");
