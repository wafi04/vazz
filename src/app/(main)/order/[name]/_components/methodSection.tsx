    ...
    <div className="bg-card rounded-lg overflow-hidden shadow-lg border border-border">
      ...
      <div className="space-y-3 p-3">
        {Object.keys(groupedMethods).map((type, index) => (
          ...
          >
            <div className="cursor-pointer" onClick={() => toggleSection(type)}>
              <div className="flex bg-primary justify-between p-4 w-full items-center mb-3">
                <span className="text-primary-foreground capitalize font-medium">
                  {type}
                </span>
                <span
                  className="text-blue-200 text-sm transition-transform duration-300"
                  style={{
