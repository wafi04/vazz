        ...
        if (orderTopUp) {
          ...
          if (layanan && pembelian) {
            ...
            if (datas) {
              ...
              if (
                currentPembelianStatus !== "SUCCESS" ||
                newStatus === "SUCCESS"
              ) {
                ...
                console.log(
                  `Skipping pembelian update because current status (${currentPembelianStatus}) is SUCCESS and new status is ${newStatus}`
                );
              }
            }
          } else {
