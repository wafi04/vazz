...
export function PaymentStatus() {
  ...
  return (
    <main className="container mx-auto px-4 sm:px-6 lg:p-8 max-w-7xl">
      ...
      {data && <TransactionDetails data={data.purchase as Transaksi} />}
    </main>
  );
}
      ...
      <div className="flex items-center gap-4 p-4 sm:p-6 w-full max-w-3xl">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-blue-200">
            Transaksi gagal, saldo otomatis kembali menjadi{" "}
            <span className="font-bold text-yellow-400">Saldo Akun</span>
          </p>
        </div>
      </div>
    </div>
